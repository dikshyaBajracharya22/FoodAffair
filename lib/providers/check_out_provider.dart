...
class CheckoutProvider with ChangeNotifier {
  ...
  DeliveryAddressModels(QueryDocumentSnapshot element) {
    ...
    deliveryAddressModel = DeliveryAddressModel(
      ...
      firstName: element.get("firstname"),//"name in firebase"//
...
////// Order /////////
  void addPlaceOderData({
    ...
    FirebaseFirestore.instance
      ...
      {
        "orderId": orderId,
        "productImage":productImagee,
        "productName": productNamee,
        "totalPrice": productPricee,
        "productQuantity": productQuantityy,
        "firstname": firstName,
        "lastname": lastName,
        "mobileNo": mobileNo,
        "street": street,
